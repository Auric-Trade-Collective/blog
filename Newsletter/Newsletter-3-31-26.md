...
- We are dabbling with cloud hosting. We currently have a VPS running on OVH Cloud. OVH Cloud is our hosting platform of choice due to their decisions to stay as environmentally friendly as they can.

Our plans currently are:

- Finding an authentication platform that works for us.
- Further developing our infrastructure to be stronger and better.
- Organizing a game development team to begin drafting and developing The Space.
- Plan a better way for our collective to work with our community.
- Work with our partner [FluxSysLang](https://github.com/FluxSysLang/Flux) to sponsor each other's ecosystems.